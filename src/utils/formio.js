...
const FORMIO_PROJECT_URL = 'formio-6eoeawk53a-uc.a.run.app/staging-jrnkhofvnfhrvsv';
...
generateToken = async (email, formName, roleName) => {
    ...
    let roleIdAuthenticated = (await project_info.getRoleAccessInfo("authenticated"))["_id"];
